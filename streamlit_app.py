...
with col1:
    # Sort to show True (Annotated) first
...
with col2:
    # Handle potential empty options to prevent StreamlitAPIException
...
with col1:
    st.metric(
        "Annotated Responses",
        issue_cnt,
        help="Total number of responses marked as annotated."
    )
with col2:
    st.metric(
        "Completion Rate",
...
# Gate celebratory effect behind 100% completion
